...
const translations = {
  es: {
    ...
    event6_title: "Taller de Pintura al Óleo",
    event6_date: "28 de Marzo",
    event6_location: "Bilbao",
    event6_attendees: "15 asistentes",
    event6_description: "Aprende técnicas básicas de pintura al óleo. Materiales incluidos. No se requiere experiencia previa.",
    // Posts content
    ...
    profile_event2_description: "Explora los últimos descubrimientos del universo con expertos internacionales.",
  ...
  en: {
    ...
    event6_title: "Oil Painting Workshop",
    event6_date: "March 28",
    event6_location: "Bilbao",
    event6_attendees: "15 attendees",
    event6_description: "Learn basic oil painting techniques. Materials included. No previous experience required.",
    // Posts content
    post1_author: "María González",
    post1_time: "2h",
    ...
    profile_event2_description: "Explore the latest discoveries of the universe with international experts.",
  ...
  fr: {
    ...
    event6_title: "Atelier de Peinture à l'Huile",
    event6_date: "28 Mars",
    event6_location: "Bilbao",
    event6_attendees: "15 participants",
    event6_description: "Apprenez les techniques de base de la peinture à l'huile. Matériel inclus. Aucune expérience préalable requise.",
    // Posts content
    post1_author: "María González",
    post1_time: "2h",
    ...
    profile_event2_description: "Explorez les dernières découvertes de l'univers avec des experts internationaux.",
  ...
  de: {
    ...
    event6_title: "Ölmalerei-Workshop",
    event6_date: "28. März",
    event6_location: "Bilbao",
    event6_attendees: "15 Teilnehmer",
    event6_description: "Lernen Sie grundlegende Ölmalerei-Techniken. Material inklusive. Keine Vorkenntnisse erforderlich.",
    // Posts content
    post1_author: "María González",
    post1_time: "2Std",
    ...
    profile_event2_description: "Entdecken Sie die neuesten Entdeckungen des Universums mit internationalen Experten.",
