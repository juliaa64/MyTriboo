...
const translations = {
  es: {
    ...
    feature_messaging_desc: "Chats privados y grupales para comunicarte con tu tribu.",
    ...
    how_subtitle: "Únete a tu tribu en 3 simples pasos",
    ...
    cta_title: "¿Listo para encontrar tu tribu?",
    ...
    posts_subtitle: "Comparte y descubre experiencias de tu tribu",
    chats_title: "Mensajes",
    chats_subtitle: "Tus conversaciones con la tribu",
    tab_profile: "Perfil",
  ...
  en: {
    ...
    feature_messaging_desc: "Private and group chats to communicate with your tribe.",
    feature_interests_title: "Multiple Interests",
    feature_interests_desc: "Select your interests: Science, Sports, Music and more.",
    how_title: "How it works?",
    how_subtitle: "Join your tribe in 3 simple steps",
    ...
    cta_title: "Ready to find your tribe?",
    ...
    posts_subtitle: "Share and discover experiences from your tribe",
    chats_title: "Messages",
    chats_subtitle: "Your conversations with the tribe",
    tab_profile: "Profile",
    ...
    create_first_event: "Create your first event for your tribe",
    my_posts_title: "Manage your posts",
    btn_create_new_post: "Create new post",
    no_more_posts: "No more posts",
    share_thoughts: "Share your thoughts with your tribe",
  },
  fr: {
    nav_home: "Accueil",
